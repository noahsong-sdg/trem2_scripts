...
if __name__ == "__main__":
    ...
    try:
        RAW_LIGANDS_DIR = os.path.join(SCRIPT_DIR, "../data/column_six/ligands_raw")
        URI_FILE = os.path.join(SCRIPT_DIR, "../data/column_six.uri") # Using the SDF.gz file URLs
        ...
        sdf_dir = os.path.join(SCRIPT_DIR, "../data/column_six/ligands_sdf")
        ...
        split_dir = os.path.join(SCRIPT_DIR, "../data/column_six/ligands_sdf_split")
